...
def plotmaker(post, params,parameters, inj, Model, Injection=None, split_by=None, saveto=None):
...
if __name__ == '__main__':
    ...
    if not args.nocorner:
        plotmaker(post, params, parameters, inj, Model, Injection=Injection, split_by=args.cornersplit)    
    if not args.nofit:
