...
#        alpha_2 = alpha_1 - 0.667
    ...
    def sph_h_tpl_log_likelihood(self, theta):
        ...
        # unpack priors
        log_Np, log_Na, log_omega0, alpha, log_fcut, log_fscale, rh, zh = theta[0],theta[1], theta[2], theta[3], theta[4], theta[5], theta[6], theta[7]
        ...
        ## get the skymap from our (rh, zh) hyperprior
        ## we do a couple transformations on the alms/blms to maintain consistency with the rest of the code
        ## the calls to blm_decompose() and blm_params_2_blms() may be unnecessary? Check later.
        map_theta = self.hierarchical_engine.breivik2020_mapmaker(rh,zh)
        sph_theta = self.hierarchical_engine.skymap_pix2sph(map_theta,self.blmax)
        blm_theta = self.hierarchical_engine.blm_decompose(sph_theta)
