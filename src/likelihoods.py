...
class likelihoods():
    ...
    def fg_pl_log_likelihood(self, theta):

        '''
        Calculate likelihood for a power-spectra based spherical harmonic analysis of the Milky Way double white dwarf GW foreground with a power-law spectrum model.
    ...
    def fg_bpl_log_likelihood(self, theta):
