...
class movingfreqDomain():
    ...
    def lisa_orbits(self, timearray):
        ...
        -----------
        rs1, rs2, rs3  :  array
            Arrays of satellite positions for reach time in timearray. e.g. rs1[1] is [x1,y1,z1] at t=timearray[1]. 
        '''
        ## Semimajor axis in m
        a = 1.496e11
...
#        z_n = np.array([[0],[0],[0]])
    ...
    def doppler_response(self, f0, theta, phi, ti, rs1, rs2, rs3):
    ...
    def tdi_isgwb_xyz_response(self, f0, ti, rs1, rs2, rs3): 
    ...
    def tdi_isgwb_response(self, f0, ti, rs1, rs2, rs3): 
